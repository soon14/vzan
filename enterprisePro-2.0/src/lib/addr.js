...
var addr = {
  ...
  WxLogin: HOST + "apiMiappEnterprise/GetSesionKey", //登录微赞后台
  loginByThirdPlatform: HOST + "apiMiappEnterprise/GetAppUserInfo", //登录微赞后台
  ...
  PayOrder: HOST + "apiMiappEnterprise/PayOrderNew", // 微信支付订单
  ...
  CancelOrder: HOST + "apiMiappEnterprise/CancelOrder", //取消订单
  GetSubscribePageSetting:HOST+"apiMiappEnterprise/GetSubscribePageSetting",//预约表配置
}
