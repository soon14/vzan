...
var canvas = {
	Drawcanvas: function () {
		var that = this
		var imgCanvas = app.globalData.shareConfig.ADImg[0] //大图
		...
		if (freeStyle == 0) {
			if (imgCanvas == undefined) {
				imgCanvas = Qrcode.replace(/http/, "https")
			} else {
				imgCanvas = imgCanvas.replace(/http/, "https")
			}
			wx.downloadFile({
				...
				success: function (res0) {
					...
					wx.downloadFile({
						...
						success: function (res) {
							...
							if (app.globalData.shareConfig.ADImg[0] == undefined) {
