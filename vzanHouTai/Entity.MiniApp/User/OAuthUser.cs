...
namespace Entity.MiniApp.User
{
    ...
    public class OAuthUser
    {
        ...
        [SqlField]
        public string ThirdOpenid { get; set; } = string.Empty;//关注公众号消息推送OpenId
        ...
        /// </summary>
        [SqlField]
        public int PayArticleCash { get; set; }
        /// <summary>
        /// 红包验证码
        /// </summary>
        [SqlField]
        public int RedBagVerifyNum
        {
            get { return _redbagverifynum; }
            set { _redbagverifynum = value; }
        }
