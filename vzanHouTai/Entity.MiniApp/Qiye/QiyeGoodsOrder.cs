...
namespace Entity.MiniApp.Qiye
{
    ...
    public class QiyeGoodsOrder
    {
        ...
        /// 商品
        /// </summary>
        //public QiyeGoods Goods { get; set; }
        /// <summary>
        /// 购物车
        /// </summary>
        public List<QiyeGoodsCart> CartList { get; set; } = new List<QiyeGoodsCart>();
        /// <summary>
        /// 物流信息
        /// </summary>
        public DeliveryFeedback DeliveryInfo { get; set; } = new DeliveryFeedback();
        /// <summary>
        /// 店铺客户电话
        /// </summary>
