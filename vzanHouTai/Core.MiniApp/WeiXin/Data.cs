...
namespace Core.MiniApp
{
    ...
    public class WxPayData
    {
        ...
        //public PayResultShop ToPayResultShop()
        //{
        //    try
        //    {
        //        PayResultShop result = new PayResultShop();
        //        result.appid = GetValue("appid") == null ? "" : GetValue("appid").ToString();
        //        result.mch_id = GetValue("mch_id") == null ? "" : GetValue("mch_id").ToString();
        //        result.attach = GetValue("attach") == null ? "" : GetValue("attach").ToString();
        //        result.err_code = GetValue("err_code") == null ? "" : GetValue("err_code").ToString();
        ...
        //                }
        //            }
        //            string orderid = WxUtils.getAttachValue(result.attach, "orderid");
        ...
        **/
        public string ToXml()
        {
            ...
            if (0 == m_values.Count)
            {
                WxPayException ex = new WxPayException("WxPayData数据为空!");
            ...
            foreach (KeyValuePair<string, object> pair in m_values)
            {
                ...
                if (pair.Value == null)
                {
                    WxPayException ex = new WxPayException("WxPayData内部含有值为null的字段!");
                    log4net.LogHelper.WriteError(this.GetType(), ex);
                    throw ex;
                }
                ...
                {
                    WxPayException ex = new WxPayException("WxPayData字段数据类型错误!");
                    log4net.LogHelper.WriteError(this.GetType(), ex);
                    throw ex;
                }
            }
        ...
        */
        public SortedDictionary<string, object> FromXml(string xml)
        {
            ...
            {
                WxPayException ex = new WxPayException("将空的xml串转换为WxPayData不合法!");
                log4net.LogHelper.WriteError(this.GetType(), ex);
                throw ex;
            }
        ...
        */
        public string ToUrl()
        {
            ...
            foreach (KeyValuePair<string, object> pair in m_values)
            {
                if (pair.Value == null)
                {
                    WxPayException ex = new WxPayException("WxPayData内部含有值为null的字段!" + pair.Key);
                    log4net.LogHelper.WriteError(this.GetType(), ex);
                    throw ex;
                }
        ...
        */
        ...
        {
            string jsonStr = new System.Web.Script.Serialization.JavaScriptSerializer().Serialize(m_values); //JsonMapper.ToJson(m_values);
            return jsonStr;
        }
        ...
        */
        ...
        //    }
        //    log4net.LogHelper.WriteInfo(this.GetType(), "Print in Web Page : " + str);
        //    return str;
        //}
