...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //, serverUrl: URL + "net/controller.ashx"
        , serverUrl:  "/js/ueditor1_4_3_3-utf8-net/utf8-net/net/controller.ashx"
        // , serverUrl:"/cgibin/filetransfer?isvote=1"
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的重新定义
        , toolbars: [[
             //'source', '|', 'undo', ' redo', '|', 'bold', 'italic', 'underline', 'strikethrough', '|', 'forecolor', 'backcolor', '|', 'removeformat', '| ', 'justifyleft', 'justifycenter ','justifyright', 'justifyjustify', '|', 'simpleupload', '| ', 'fontsize', 'link', 'unlink',
		...
		, whitList: {
		    ...
		    audio: ['src', 'class', 'height', 'width', 'style', 'autoplay'],
		    source: ['src', 'type'],
