...
var CHINESE_INFORMAL_MULTIPLIERS = 'Ê®°ÙÇ§Èf';
var CHINESE_FORMAL_MULTIPLIERS = 'Ê°°ÛÇªÈf';
var JAPANESE_NEGATIVE = '¥Þ¥¤¥Ê¥¹';
var KOREAN_NEGATIVE = '???? ';
...
var createCounterText = exports.createCounterText = function createCounterText(value, type, appendSuffix) {
    ...
    switch (type) {
        ...
        case _listStyle.LIST_STYLE_TYPE.CJK_DECIMAL:
            return createCounterStyleFromSymbols(value, '©–Ò»¶þÈýËÄÎåÁùÆß°Ë¾Å', cjkSuffix);
        ...
        case _listStyle.LIST_STYLE_TYPE.CJK_EARTHLY_BRANCH:
            return createCounterStyleFromSymbols(value, '×Ó³óÒúÃ®³½ËÈÎçÎ´ÉêÓÏÐçº¥', cjkSuffix);
        case _listStyle.LIST_STYLE_TYPE.CJK_HEAVENLY_STEM:
            return createCounterStyleFromSymbols(value, '¼×ÒÒ±û¶¡Îì¼º¸ýÐÁÈÉ¹ï', cjkSuffix);
        case _listStyle.LIST_STYLE_TYPE.CJK_IDEOGRAPHIC:
        case _listStyle.LIST_STYLE_TYPE.TRAD_CHINESE_INFORMAL:
            return createCJKCounter(value, 'ÁãÒ»¶þÈýËÄÎåÁùÆß°Ë¾Å', CHINESE_INFORMAL_MULTIPLIERS, 'Ø“', cjkSuffix, CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
        case _listStyle.LIST_STYLE_TYPE.TRAD_CHINESE_FORMAL:
            return createCJKCounter(value, 'ÁãÒ¼ÙE…¢ËÁÎéê‘Æâ°Æ¾Á', CHINESE_FORMAL_MULTIPLIERS, 'Ø“', cjkSuffix, CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
        case _listStyle.LIST_STYLE_TYPE.SIMP_CHINESE_INFORMAL:
            return createCJKCounter(value, 'ÁãÒ»¶þÈýËÄÎåÁùÆß°Ë¾Å', CHINESE_INFORMAL_MULTIPLIERS, '¸º', cjkSuffix, CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
        case _listStyle.LIST_STYLE_TYPE.SIMP_CHINESE_FORMAL:
            return createCJKCounter(value, 'ÁãÒ¼·¡ÈþËÁÎéÂ½Æâ°Æ¾Á', CHINESE_FORMAL_MULTIPLIERS, '¸º', cjkSuffix, CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
        case _listStyle.LIST_STYLE_TYPE.JAPANESE_INFORMAL:
            return createCJKCounter(value, '©–Ò»¶þÈýËÄÎåÁùÆß°Ë¾Å', 'Ê®°ÙÇ§Íò', JAPANESE_NEGATIVE, cjkSuffix, 0);
        case _listStyle.LIST_STYLE_TYPE.JAPANESE_FORMAL:
            return createCJKCounter(value, 'Áã‰Òr²ÎËÄÎéÁùÆß°Ë¾Å', 'Ê°°ÙÇ§Íò', JAPANESE_NEGATIVE, cjkSuffix, CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS);
        case _listStyle.LIST_STYLE_TYPE.KOREAN_HANGUL_FORMAL:
            return createCJKCounter(value, '??????????', '????', KOREAN_NEGATIVE, koreanSuffix, CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS);
        case _listStyle.LIST_STYLE_TYPE.KOREAN_HANJA_INFORMAL:
            return createCJKCounter(value, 'ÁãÒ»¶þÈýËÄÎåÁùÆß°Ë¾Å', 'Ê®°ÙÇ§Èf', KOREAN_NEGATIVE, koreanSuffix, 0);
        case _listStyle.LIST_STYLE_TYPE.KOREAN_HANJA_FORMAL:
            return createCJKCounter(value, 'ÁãÒ¼ÙE…¢ËÄÎåÁùÆß°Ë¾Å', 'Ê°°ÙÇ§', KOREAN_NEGATIVE, koreanSuffix, CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS);
        ...
        case _listStyle.LIST_STYLE_TYPE.HIRAGANA:
            return createCounterStyleFromSymbols(value, '¤¢¤¤¤¦¤¨¤ª¤«¤­¤¯¤±¤³¤µ¤·¤¹¤»¤½¤¿¤Á¤Ä¤Æ¤È¤Ê¤Ë¤Ì¤Í¤Î¤Ï¤Ò¤Õ¤Ø¤Û¤Þ¤ß¤à¤á¤â¤ä¤æ¤è¤é¤ê¤ë¤ì¤í¤ï¤ð¤ñ¤ò¤ó');
        case _listStyle.LIST_STYLE_TYPE.HIRAGANA_IROHA:
            return createCounterStyleFromSymbols(value, '¤¤¤í¤Ï¤Ë¤Û¤Ø¤È¤Á¤ê¤Ì¤ë¤ò¤ï¤«¤è¤¿¤ì¤½¤Ä¤Í¤Ê¤é¤à¤¦¤ð¤Î¤ª¤¯¤ä¤Þ¤±¤Õ¤³¤¨¤Æ¤¢¤µ¤­¤æ¤á¤ß¤·¤ñ¤Ò¤â¤»¤¹');
        case _listStyle.LIST_STYLE_TYPE.KANNADA:
            return createCounterStyleFromRange(value, 0xce6, 0xcef, true, defaultSuffix);
        case _listStyle.LIST_STYLE_TYPE.KATAKANA:
            return createCounterStyleFromSymbols(value, '¥¢¥¤¥¦¥¨¥ª¥«¥­¥¯¥±¥³¥µ¥·¥¹¥»¥½¥¿¥Á¥Ä¥Æ¥È¥Ê¥Ë¥Ì¥Í¥Î¥Ï¥Ò¥Õ¥Ø¥Û¥Þ¥ß¥à¥á¥â¥ä¥æ¥è¥é¥ê¥ë¥ì¥í¥ï¥ð¥ñ¥ò¥ó', cjkSuffix);
        case _listStyle.LIST_STYLE_TYPE.KATAKANA_IROHA:
            return createCounterStyleFromSymbols(value, '¥¤¥í¥Ï¥Ë¥Û¥Ø¥È¥Á¥ê¥Ì¥ë¥ò¥ï¥«¥è¥¿¥ì¥½¥Ä¥Í¥Ê¥é¥à¥¦¥ð¥Î¥ª¥¯¥ä¥Þ¥±¥Õ¥³¥¨¥Æ¥¢¥µ¥­¥æ¥á¥ß¥·¥ñ¥Ò¥â¥»¥¹', cjkSuffix);
...
var BREAK_NOT_ALLOWED = exports.BREAK_NOT_ALLOWED = '¡Á';
var BREAK_ALLOWED = exports.BREAK_ALLOWED = '¡Â';
...
var _lineBreakAtIndex = function _lineBreakAtIndex(codePoints, classTypes, indicies, index, forbiddenBreaks) {
    ...
    // LB17 Do not break within ¡®¡ª¡ª¡¯, even with intervening spaces.
...
var parseLinearGradient = function parseLinearGradient(args, bounds, hasPrefix) {
    ...
    // if there is a prefix, the 0¡ã angle points due East (instead of North per W3C)
