...
function initMap() {
    ...
    function(c) {
        ...
        geoc.getLocation(b, function (rs) {
            var addComp = rs.addressComponents;
            if (rs.address) {
                Fe.G('currentAddress').value = rs.address;
            }
...
function setInputPoint(a) {
    ...
    //});   
    if (a.address) {
        Fe.G('currentAddress').value = a.address;
    }
...
function localsearch() {
    ...
    var d = {
        onSearchComplete: function(w) {
            clearLastResult();
            if (b.getStatus() == BMAP_STATUS_SUCCESS || b.getStatus() == BMAP_STATUS_CITY_LIST) {
...
function bindEvent() {
    ...
    var b = function(g) {
        ...
        d[g].point.address = temp.pt[g].address;
