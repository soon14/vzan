 ...
 */
exports.getModel = function (reqData) {
 ...
 * @param {function} @callback  回调函数
 */
exports.getList = function (reqData) {
    var deferred = when.defer();
    paramData = extend(true, paramData, reqData);
    connection = mysql.createConnection(connection.config);
    //开启连接
 ...
 * @param {function} @callback  回调函数
 */
exports.getCount = function (reqData) {
    var deferred = when.defer();
    paramData = extend(true, paramData, reqData);
    connection = mysql.createConnection(connection.config);
    //开启连接
 ...
 */
exports.updateModel = function (reqData) {
    var deferred = when.defer();
 ...
 * @param {function} @callback 回调函数
 */
exports.insertModel = function (reqData) {
    var deferred = when.defer();
