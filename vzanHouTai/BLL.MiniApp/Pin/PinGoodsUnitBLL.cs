...
{
    public class PinGoodsUnitBLL : BaseMySql<PinGoodsUnit>
    {
        #region 单例模式
        private static PinGoodsUnitBLL _singleModel;
        private static readonly object SynObject = new object();

        private PinGoodsUnitBLL()
        {

        }

        public static PinGoodsUnitBLL SingleModel
        {
            get
            {
                if (_singleModel == null)
                {
                    lock (SynObject)
                    {
                        if (_singleModel == null)
                        {
                            _singleModel = new PinGoodsUnitBLL();
                        }
                    }
                }
                return _singleModel;
