...
// 点餐接口
// 店铺信息
Address.GetFoodsDetail = HOST + "apiMiappFoods/GetFoodsDetail"
// 首页商品分类信息
Address.GetGoodsTypeList = HOST + "apiMiappFoods/GetGoodsTypeList"
//首页商品信息
Address.GetGoodsList = HOST + "apiMiappFoods/GetGoodsList"
// 获取商品详情
Address.GetGoodsDtl = HOST + "apiMiappFoods/GetGoodsDtl"
// 获取购物车列表
Address.getGoodsCarData = HOST + "apiMiappFoods/getGoodsCarData"
// 获取我的收货地址
Address.GetMyAddress = HOST + "apiMiappFoods/GetMyAddress"
// 新增收货地址
Address.AddOrEditMyAddressDefault = HOST + "apiMiappFoods/AddOrEditMyAddressDefault"
// 获取我的订单
Address.getMiniappGoodsOrder = HOST + "apiMiappFoods/getMiniappGoodsOrder"
// 删除我的收货地址
Address.deleteMyAddress = HOST + "apiMiappFoods/deleteMyAddress"
// 提交商品到购物车
Address.addGoodsCarData = HOST + "apiMiappFoods/addGoodsCarData"
//购物车生成订单
// Address.addMiniappGoodsOrder = HOST + "apiMiappFoods/addMiniappGoodsOrder"
//下单
Address.AddPayOrder_Store = HOST + "apiMiappFoods/addMiniappGoodsOrder"
// 支付
Address.PayOrder = HOST + "apiMiappFoods/PayOrder"
// 更新订单状态
Address.updateMiniappGoodsOrderState = HOST + "apiMiappFoods/updateMiniappGoodsOrderState"
// 查看订单
Address.getMiniappGoodsOrderById = HOST + "apiMiappFoods/getMiniappGoodsOrderById"
// 查看配送距离
Address.GetDistanceForFood = HOST + "apiMiappFoods/GetDistanceForFood"
// 表单测试
Address.testMuBang = HOST + "apiMiappFoods/testMuBang"
module.exports = {
  Address: Address,
}