...
Page({
  ...
  data: {
    entry_order: [{
      ...
      {
        fontcss: 'dzicon icon-icon_wodepingjia- eo_icon t44 l44',
        content: '待评价',
        red_point: '0',
        state: 4,
        groupState: -999,
  ...
  url_nt: function(e) {
    ...
    if (index == 0) {
      template.gonewpagebyrd('/pages/store/storeIndex/storeIndex?storeid=' + this.data.storeid)
    } else if (index == 1) {
      template.gonewpagebyrd('/pages/store/store_classify/store_classify?storeid=' + this.data.storeid)
    } else {
      if (getCurrentPages()[getCurrentPages().length - 1].route == "pages/store/store_my/store_my") {
        return
      }
      template.gonewpagebyrd('/pages/store/store_my/store_my?storeid=' + this.data.storeid)
    }
  },
  ...
  onShow: function() {
    var that = this
    // var findPageIndex = getCurrentPages().findIndex(f => f.route == 'pages/store/store_my/store_my')
