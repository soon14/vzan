...
// Address.GetVipInfo = "http://apiwx.vzan.com/"  + "apiMiappEnterprise/GetVipInfo"// 获取会员信息
...
//预约购物
Address.GetReserveGoodClass = HOST + "apiMiappEnterprise/GetReserveGoodClass"//获取预约购物商品分类
Address.AddReservation = HOST + "apiMiappEnterprise/AddReservation"//预约下单
Address.GetReservation = HOST + "apiMiappEnterprise/GetReservation"//获取预约详情
Address.appoint_addGoodsCarData = HOST + "apiMiappEnterprise/addGoodsCarData"//添加到购物车
Address.CancelResevation = HOST + "apiMiappEnterprise/CancelResevation"//取消预约
Address.GetReserveMenu = HOST + "apiMiappEnterprise/GetReserveMenu"//获取已预约的菜单
// Address.GetReserveGoodClass = "http://apiwx.vzan.com/" + "apiMiappEnterprise/GetReserveGoodClass"//获取预约购物商品分类
// Address.AddReservation = "http://apiwx.vzan.com/" + "apiMiappEnterprise/AddReservation"//预约下单
// Address.GetReservation = "http://apiwx.vzan.com/" + "apiMiappEnterprise/GetReservation"//获取预约详情
// Address.appoint_addGoodsCarData = "http://apiwx.vzan.com/" + "apiMiappEnterprise/addGoodsCarData"//添加到购物车
// Address.CancelResevation = "http://apiwx.vzan.com/" + "apiMiappEnterprise/CancelResevation"//取消预约
// Address.GetReserveMenu = "http://apiwx.vzan.com/" + "apiMiappEnterprise/GetReserveMenu"//获取已预约的菜单
