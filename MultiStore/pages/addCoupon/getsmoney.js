...
Page({
  ...
  onLoad: function (options) {
    var that = this
    pageRequest.GetReductionCard(that, app.globalData.reduction.Id, app.globalData.dbOrderId, 0)
    setTimeout(function () {
  ...
  onShareAppMessage: function () {
    ...
    return {
      title: '社交立减金',
      path: '/pages/addCoupon/invitegetsmoney?couponsId=' + app.globalData.reduction.Id + '&orderId=' + app.globalData.dbOrderId
    }
  }
})